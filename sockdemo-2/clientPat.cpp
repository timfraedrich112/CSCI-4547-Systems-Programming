// clientPat.cpp -- open an internet socket and talk into it.
...
const char* const line[] = {
	"Politeness, by Alan Alexander Milne\n",
	"When people ask me, I always tell them:\n",
	"\"Quite well, thank you, I'm very glad to say.\"\n",
	"If people ask me, I always answer,\n",
	"\"Quite well, thank you, how are you to-day?\"\n",
	"I always answer, ","I always tell them, \n",
	"If they ask me ","Politely.....\n",
	"BUT SOMETIMES\n","I wish\n","That they wouldn't.\n"
};
...
/* History:
 ...
 //
 // Output:
 lily:~/<3>Lecture/L10-sockets/sockdemo-2~> clientPat localhost
 client socket is  {
 sin_family      =
 sin_addr.s_addr = 127.0.0.1
 sin_port (!!!)  = 1099
 };
 clientPat: connection established to localhost.
